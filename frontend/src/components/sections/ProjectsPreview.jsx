...
const projects = [
  {
    ...
    summary:
      'Display-area project presenting Babuye aluminium and glass systems, finishes, profiles, and project-ready detail standards.',
  ...
  },
  {
    ...
    location: 'Upper Hill',
    summary:
      'A 4th Ngong Avenue and Bishops Road reference project for coordinated facade, access, and aluminium-glass package planning.',
  ...
  },
  {
    ...
    location: 'Ruiru',
    summary:
      'Residential glazing and aluminium systems shaped around daylight, privacy, ventilation, and clean architectural lines.',
    ...
    <section className="bg-white py-24 sm:py-32">
      <Container>
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          <SectionHeader
            title="Selected projects across showroom, commercial, healthcare, hospitality, and residences."
            italicWords={[
              'showroom',
              'commercial',
              'healthcare',
          ...
          >
            The project list reflects Babuye’s market role across Nairobi,
            Kenya, and regional hospitality work.
          </SectionHeader>
